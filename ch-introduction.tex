...
\begin{figure}[hp]
\centering
\includegraphics[width=200pt]{hybrid-HaP.png}
...
This density emerges when computing the expectation value of the potential energy of a single electron \(r_k\) due to the nuclei.
\begin{equation}
\label{eq:V_ext}
...
By circumventing the wave function, the many-electron problem solving for the configurational energy can be effectively cast to a sum of single-electron problems with theoretically no compromise on accuracy.
\begin{equation}
\label{eq:funco}
...
\begin{figure}[htbp]
\centering
\includesvg[width=300pt]{./.ob-jupyter/1111b77f7e7ed1fa50791a404ec9652e766a082b}
