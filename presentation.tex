...
\item A accommodates amines with large effective ionic radii\autocite{kieslich-2015-exten-toler}
\end{itemize}
...
\section{Data}
\label{sec:org3d5d157}
\begin{frame}[label={sec:orgedbc90f}]{Effect of DFT Functionals Levels of Theory}
\begin{center}
...
\begin{frame}[label={sec:org75c4bee}]{Absorbance Relates to Power Conversion in Our Data}
 
\begin{center}
\includesvg[width=370pt]{./.ob-jupyter/3d9a2ab16919627b5827851152eba8c5c9d8f494}
\end{center}
...
\begin{frame}[label={sec:orgffd78e8}]{publications presentations and other contributions}
\begin{columns}
...
\begin{itemize}
\item \url{https://github.com/PanayotisManganaris/cmcl}
\item \url{https://github.com/PanayotisManganaris/yogi}
\item \url{https://github.com/PanayotisManganaris/spyglass}
\item \url{https://github.com/PanayotisManganaris/pysisso}
\end{itemize}
\end{block}
\end{column}
\end{columns}
...
\begin{frame}[label={sec:orge57ea35}]{Conclusions}
\begin{itemize}
