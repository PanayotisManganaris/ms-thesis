...
\begin{frame}[label={sec:org2b7a124}]{Sample of 14-Dimensional Composition Space}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org1ee19d0}]{Collecting Data is Hard}
\begin{columns}
\begin{column}{0.7\columnwidth}
...
\label{sec:org4e1033f}
\begin{frame}[label={sec:org91eade9}]{Density Functional Theory and Simulation Fidelities}
...
\begin{frame}[label={sec:org7c180a5}]{DFT Calculation of Perovskite Band Gaps in Literature}
\begin{center}
...
\begin{frame}[label={sec:org0c138b5}]{Machine Learning for Property Prediction}
\begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:orgbf08fa9}]{Data Driven Framework for Perovskite Discovery}
\begin{center}
