...
\begin{frame}[label={sec:orgbe8b3aa},fragile]{Seven Step Semiconductor Composition Optimization}
 \begin{enumerate}
...
\begin{frame}[label={sec:org46a7e04}]{Conclusions}
\begin{itemize}
...
\begin{frame}[label={sec:orgd8888fb},fragile]{Publications Presentations and Other Contributions}
 \begin{columns}
