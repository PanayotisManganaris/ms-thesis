...
\begin{frame}[label={sec:org8c2262e}]{Sample of 14-Dimensional Composition Space}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:orgc0cad37}]{Collecting Data is Hard}
\begin{columns}
\begin{column}{0.7\columnwidth}
...
\section{Data}
\label{sec:orgeae269f}
\begin{frame}[label={sec:org7b743dd}]{Effect of DFT Functionals Levels of Theory}
...
\begin{frame}[label={sec:org568ad33}]{Spectroscopic Limited Maximum Efficiency (SLME)}
...
\begin{frame}[label={sec:org643fdee}]{Absorbance Relates to Efficiency via Band Gap in Our Data}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9857e7c},fragile]{Tuning Multi-Fidelity Model Performance by Selecting Hyper-parameters}
 \begin{columns}
\begin{column}{0.7\columnwidth}
\begin{center}
...
\section{Models}
\label{sec:org2ebedb6}
\begin{frame}[label={sec:org7ea9233}]{Model Training Method}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{enumerate}
...
\begin{frame}[label={sec:orga1480bd}]{Test 282 Band Gap Predictions}
...
\begin{frame}[label={sec:orge2f157b}]{SISSO Expression}
\begin{align*}
