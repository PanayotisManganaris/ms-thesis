...
\begin{frame}[label={sec:org1ee19d0}]{Density Functional Theory (DFT)}
\begin{itemize}
...
\begin{frame}[label={sec:orgbf08fa9}]{Effect of DFT Functionals Levels of Theory}
...
\begin{frame}[label={sec:org4baaeb2}]{Multi-fidelity Machine Learning}
\[
...
\end{frame}
\appendix
\begin{frame}[label={sec:org2d1c8fe}]{Data Pre-Processing}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:orgfb798ca}]{DFT Functionals Effect Band Structure Calculation in HaPs}
\begin{itemize}
\item D3
\item SOC
