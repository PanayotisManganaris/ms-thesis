...
\begin{abstract}
  A wide range of optoelectronic applications demand semiconductors to
  be optimized for purpose. My research focused on addressing the
  problem of optimizing Halide perovskite composition for photovoltaic
  ...
  with band gaps in an ideal range of 1 to 2.5 eV for visible light
  spectrum absorption.
  ...
  of these models is to predict the perovskite band gap using the
  ...
  I utilize a recently published density
  functional theory (DFT) dataset of > 1300 perovskite band gaps from 4
  ...
  of 0.124738 on the total dataset and 0.154448 on just the experimental
  ...
  Shapley additive explanation (SHAP) analysis of learned descriptors.
  Finally, the best model is deployed for prediction
  of experimental band gap of \textasciitilde{}40,000 hypothetical compounds,
  based on which we screen \textasciitilde{}3000 stable compounds with band gap predicted to be
