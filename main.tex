...
functional theory (DFT) dataset of > 1300 perovskite bandgaps from 4
different levels of theory, added to an experimental perovskite
bandgap dataset of ~100 points, to train random forest
...
that RFR yields the best model with a bandgap root mean square error
