...
\begin{abstract}
  ...
  band gap dataset of ~100 points, to train random forest
  ...
  of experimental band gap of ~40,000 hypothetical compounds,
  based on which we screen ~3000 stable compounds with band gap predicted to be
  between 1 and 2 eV.
\end{abstract}
