...
** Rapid Rise in Efficiency of Perovskite PVs                      :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
*** col                                                             :BMCOL:
...
#+CAPTION: 
[[file:./.ob-jupyter/10239da69f2d0128ccd122b2d3cf4ab49fea84a4.svg]]
:end:
...
# codomain side
# - choose to model perovskite band gaps
# domain side
# - various empirical tolerance factors emphasize using the ionic radius
# - use the Electronegativity, etc, etc
...
:BEAMER_env: frame
:END:
# consider focusing only on one equation -- maybe just Octahedral
...
Empiricallly, it is *Necessary* that A must be much larger than B
...
# we will use this information in our models, but in what way?
# maybe, dynamically compute effective ionic radii
- Elemental Radii are well documented in public databases
- Molecular Radii are defined in various ways, mostly for small
  molecules.
** Motives for Alternative Features                                :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
...
# I selected this methods
# because
** ML Architectures                                                :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
# Gaussian process modeling is a particularly elegant sort of machine
# learning. Lots of history and a large body of work continuously
# improving them.
*** Non-Parametric Regression                                     :B_block:
:PROPERTIES:
:BEAMER_env: block
:END:
- Decision Tree
...
- SISSO
- Neural Network
- Gaussian Process (sometimes)

* COMMENT Models
* COMMENT Results
** Screening on Band Gap                                           :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
# We model bend gaps because of correlation to SLME
*** col                                                             :BMCOL:
:PROPERTIES:
:BEAMER_col: 0.5
:END:
...
| test      | 0.063789 |
| train     | 0.211039 |
** Decomposition Energy learning curve                             :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
#+attr_latex: :width 250
[[file:/home/panos/data/alignn/dist_de_32_100/lc.svg]]
** Decomposition Energy parity                                     :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
*** col                                                             :BMCOL:
