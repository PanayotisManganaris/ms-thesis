...
:END:
the work we did in [cite/title:@yang-2023-high-throug]
...
The work I did in [cite/title:@manganaris-2023-multi-fidel]
...
:BEAMER_col: 0.5
:END:
#+begin_src jupyter-python :post wrap(*this*, w="180pt")
  ...
  for i, g in enumerate(freq.site.unique()):
      ...
      p.update_yaxes(col=1, row=rowdict[i],
...
#+attr_latex: :width 180pt
[[file:./.ob-jupyter/4c75465e116d1d35a66facd2e8dcaa658286c373.svg]]
:end:
...
[[file:./.ob-jupyter/ca72ee259641cdd0bcbb7685d0bd737c8163e268.svg]]
:end:
...
for example: \epsilon_i \sim N(0,\sigma_i^2), with \sigma_i^2 known
for each of the various fidelities in the data, or

only known as a categorical level, or unknown and to be estimated from
the data and any prior knowledge about its distribution,
...
** Compare RMSE of different subsets                               :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
...
:BEAMER_col: 0.5
:END:
- partitioned scores obtained from final HPO iteration
- EXP rmse was more heavily weighted for parameter selection
  - GPR actually outperforms RFR in EXP subset
  - RFR shows better extrapolative ability
...
:END:
#+begin_src jupyter-python
  randdf = screen[~screen.Formula.str.contains(r"Pb", regex=False)][["Formula", "bg_eV"]].sample(10)
...
|       | Formula                                   | band gap [eV] |
|-------+-------------------------------------------+---------------|
| 18743 | FA0.125K0.750Rb0.125Ca1.000Br1.000        | 1.855247      |
| 12770 | K1.000Sn1.000Br0.125Cl0.417I0.458         | 1.579396      |
| 31435 | Cs0.625MA0.375Sr1.000Cl1.000              | 1.914944      |
| 18623 | FA0.125K0.500MA0.125Rb0.250Sr1.000Br1.000 | 1.646356      |
| 19146 | FA0.250K0.375MA0.250Rb0.125Sn1.000I1.000  | 1.480291      |
| 2909  | Rb1.000Ca1.000Br0.250Cl0.167I0.583        | 1.701664      |
| 13745 | K1.000Ge0.625Sr0.375Br1.000               | 1.705146      |
| 30268 | Cs0.375FA0.125K0.125MA0.375Sn1.000Cl1.000 | 1.756766      |
| 1505  | Rb1.000Ge1.000Br0.042Cl0.917I0.042        | 1.900707      |
| 31436 | Cs0.625MA0.375Sr1.000Br1.000              | 1.971531      |
:end:
...
#+attr_latex: :width 400pt
[[file:./.ob-jupyter/3c8a6786b8ef573188204a1b3d68064ee64a3381.svg]]
:end:
