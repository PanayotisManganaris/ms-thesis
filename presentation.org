...
** Random Forest Regression (RFR)                                  :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
*** col                                                             :BMCOL:
...
- tree ensemble explains variance in data
- tree ensemble reduce the variance of error

** Gaussian Process Regression (GPR)                               :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
