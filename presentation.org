...
** TODO Design Goals of Perovskite Mixing                          :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
*** col                                                             :BMCOL:
...
:BEAMER_col: 0.5
:END:
**** Deficiencies in Current Perovskite PVs                      :B_block:
:PROPERTIES:
:BEAMER_env: block
:END:
...
[[file:./.ob-jupyter/c00e21154fba8393ff3d8a9003f9b15830be6eaf.svg]]
:end:

**** COMMENT fig all components                          :B_ignoreheading:
:PROPERTIES:
:BEAMER_env: ignoreheading
:END:
#+begin_src jupyter-python :post wrap(*this*, w="150pt :options inkscapeformat=png, inkscapedpi=300")
  ...
  p.update_traces(textinfo="label+percent parent")
...
#+attr_latex: :width 150pt :options inkscapeformat=png, inkscapedpi=300
[[file:./.ob-jupyter/9ef1f8c88bbb340e0556a7542b086725069dbe80.svg]]
:end:
...
:BEAMER_col: 0.5
:END:
**** *207+ Million* Design Candidates                            :B_block:
:PROPERTIES:
:BEAMER_env: block
:END:

composition space experiences combinatorial scaling with
1. size of supercell
2. constituent options

No distinct patterns between constituents and performance-relevant properties

 demands data-driven design based on
...
** ML + DFT for Materials Discovery
...
# Forces from DFT vs learned Forces plot
# show famous discoveries
# show ML descriptor "shortcut"
...
** Random Forest                                                   :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:

** Gaussian Process                                                :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
...
** Collecting experimental data is hard                            :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
# show slide from almora and jacobson paper overview
# also mention that PBE and HSE take time to generate -- Arun' been getting data for years
** COMMENT Features of Perovskites Descriptive of Band Gap                 :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
*** composition vectors
...
** COMMENT Constituent Properties                                          :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
...
#+attr_latex: :width 300pt
[[file:./.ob-jupyter/7b1068ba48c7e5c707b63c3e5f7f86120dfef44e.svg]]
:end:
...
#+attr_latex: :width 300pt
[[file:./.ob-jupyter/7d033c28e36559b613f19ef0845e7a919c808d7a.svg]]
:end:
...
#+attr_latex: :width 300pt
[[file:./.ob-jupyter/1020485c278cdd6b4bc993f9216d595dcf4d08e2.svg]]
:end:
...
:BEAMER_env: frame
:END:
#+begin_src jupyter-python :post wrap(*this*, w="450pt :options inkscapeformat=png, inkscapedpi=300")
    ...
    p0.update_layout(width=1500)

    p0.update_traces(marker_line=dict(color = 'black', width = 1))

    p0.add_annotation(x=2.5, y=6, xref='x', yref='y',
                      text="r2 = 0.992646<br>maxerr = 0.803245<br>rmse = 0.124738<br>", font_size=20,
                      showarrow=False)

    p0.add_annotation(x=2.5, y=6, xref='x2', yref='y',
                      text="r2 = 0.988467<br>maxerr = 1.283692<br>rmse = 0.156214<br>", font_size=20,
                      showarrow=False)

    p0.add_annotation(x=2.5, y=6, xref='x3', yref='y',
                      text="r2 = 0.888011<br>maxerr = 2.171309<br>rmse = 0.475881<br>", font_size=20,
                      showarrow=False)
...
[[file:./.ob-jupyter/f135c78f3459b792a3436307ab575dd3e1669074.svg]]
:end:
...
:BEAMER_env: frame
:END:
** COMMENT Shapely Additive Explanation (SHAP)                             :B_frame:
:PROPERTIES:
:BEAMER_env: frame
:END:
...
#+DOWNLOADED: screenshot @ 2023-05-19 13:42:16
#+attr_latex: :width=450
[[file:Models/2023-05-19_13-42-16_screenshot.png]]
