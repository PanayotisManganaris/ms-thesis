...
** TODO My Thesis Design Goals                                     :B_frame:
...
#+begin_src jupyter-python :post wrap(*this*, w="430pt :options inkscapeformat=png, inkscapedpi=300")
  ...
  p0.add_annotation(x=2.5, y=6, xref='x', yref='y',
                    text="r2 = 0.99<br>maxerr = 0.80<br>rmse = 0.12<br>", font_size=40,
                    showarrow=False)

  p0.add_annotation(x=2.5, y=6, xref='x2', yref='y',
                    text="r2 = 0.98<br>maxerr = 1.28<br>rmse = 0.15<br>", font_size=40,
                    showarrow=False)

  p0.add_annotation(x=2.5, y=6, xref='x3', yref='y',
                    text="r2 = 0.88<br>maxerr = 2.17<br>rmse = 0.47<br>", font_size=40,
                    showarrow=False)
...
- add details
- best model selected from 30000 models
...
:BEAMER_env: frame
:END:
- Defects paper, GNN paper, *my paper*, Jiaqi's.
= presentation (DS02 poster), symposium, Nanohub tutorial
- My github, yogi, cmcl, spyglass, pysisso, etc
