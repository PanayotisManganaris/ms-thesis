...
** DONE COMMENT Random Forest Regression (RFR)
:PROPERTIES:
:BEAMER_env: frame
:END:
:LOGBOOK:
...
** DONE COMMENT Gaussian Process Regression (GPR)
:PROPERTIES:
:BEAMER_env: frame
:END:
:LOGBOOK:
...
** DONE COMMENT Sure-Independence Screening and Sparsifying Operator (SISSO)
:PROPERTIES:
:BEAMER_env: frame
:END:
:LOGBOOK:
...
:END:
# add a figure showing a sisso expression from literature
*** col
:PROPERTIES:
:BEAMER_col: 0.4
:END:
