...
#+begin_src jupyter-python :post wrap(*this*, w="1000pt", c="label:fig:errval Distribution of leave-one-composition-out cross-validation errors weighted by the size of validation sets")
    p = px.histogram(
...
| rmse_PBE             |  0.18 |  0.11 |
| rmse_HSE             |  0.22 |  0.11 |
| rmse_HSE(SOC)        |  0.21 |  0.10 |
| rmse_HSE-PBErel(SOC) |  0.20 |  0.10 |
:end:
