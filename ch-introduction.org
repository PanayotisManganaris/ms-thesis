...
#+begin_src jupyter-python :post wrap(*this*, w="350pt", c="label:fig:nrel Rapid rise in cummulative maximum of HaP PCEs")
  color_map = {
...
[[file:./.ob-jupyter/f1bd7aa56a617cb3ef7ce678a9d45172a2916343.svg]]
:end:
...
#+begin_src jupyter-python :post wrap(*this*, w="150pt :options inkscapeformat=png, inkscapedpi=300", c="label:fig:domainstats The cardinal mixing sample space contains equal fractions of each element")
...
[[file:./.ob-jupyter/9e0366470dfde761b88596ec0201cfdd3b190f95.svg]]
:end:

#+begin_src jupyter-python :post wrap(*this*, w="150pt :options inkscapeformat=png, inkscapedpi=300", c="label:fig:domainmix The cardinal mixing sample space contains mostly B-site mixed compounds")
...
[[file:./.ob-jupyter/a91a51588adf9751defe3ea10ecce816979590c2.svg]]
:end:
...
SLME accounts for more energetic processes than the Shockley-Queisser criterion (\(bg \approx 1.3\)) allowing for a range of performant bandgaps to be identified according to level of theory[cite:@yu-2012-ident-poten p.1]
Experimental data[cite:@almora-2020-devic-perfor] broadly agrees with PBE simulation, so the range of 1 to 2 \units{\electronvolts}.
...
#+begin_src jupyter-python :post wrap(*this*, w="500pt", c="label:fig:slme PBE SLME of sample compares to experimental PCE and cleanly demarcates competitive range of band gaps")
...
[[file:./.ob-jupyter/60f8cf0b348fa5343e2e4248196e31cfd76edac0.svg]]
:end:
...
** DONE COMMENT Perovskite Formability
:PROPERTIES:
:BEAMER_env: frame
:END:
:LOGBOOK:
